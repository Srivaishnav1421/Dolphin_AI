...
export class WebsocketService implements OnDestroy {
  ...
  private readonly POLL_URL  = 'http://localhost:8000/api/brain/events/recent';
  private readonly WS_URL    = 'http://localhost:8000/ws/brain';
