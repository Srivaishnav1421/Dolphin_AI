...
out_path = '/home/srivan/Desktop/Chubby_Dolphin_AI/extracted_user_request.txt'

if os.path.exists(log_path):
    with open(log_path, 'r') as f:
        lines = f.readlines()
    
    # We saw it was around line 1933 or 1934 (0-indexed 1933)
    # Let's search for the line that has "MASTER PRODUCT AUDIT"
    target_line = None
    for line in lines:
